...
#include<unistd.h>
#include<math.h>
#include<libguile.h> //needs guile, guile-dev
...
main (int argc, char* argv[])
{
  ...
  scm_with_guile (&register_functions, NULL);//transfer the provided routine register function to guile
  scm_shell (argc, argv);//pases the arguments to guile shell, call guile REPL
